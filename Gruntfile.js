...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    "shell": {
      ...
      "update-post-types-order-options": {
        "command": util.format('wp option update cpto_options \'%s\' --format="json" --path="%s"', JSON.stringify(config.management['post-types-order']), config.management.path)
      },
